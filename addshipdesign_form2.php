...
function designCreateBody()
{
	...
	echo '<tr><td>Shields:</td><td><input type="button" value="-" onclick="minus(\'shields\',0)"><input type="text" size="4" name="shields" id="shields" value="0" onchange="validateField(\'shields\',',$hullsize,',0,',$maxpartsize,');"><input type="button" value="+" onclick="plus(\'shields\',',$maxpartsize,')" ></td><td>Defense:</td><td><span id="defense">',$hullsize,'</span> HP</td></tr>', $eol;
	echo '<tr><td>Cargo:</td><td><input type="button" value="-" onclick="minus(\'cargo\',0)"><input type="text" size="4" name="cargo" id="cargo" value="0" onchange="validateField(\'cargo\',',$hullsize,',0,',$maxpartsize,');"><input type="button" value="+" onclick="plus(\'cargo\',',$maxpartsize,')"></td><td>Capacity:</td><td><span id="capacity">0</span> Units</td></tr>', $eol;
