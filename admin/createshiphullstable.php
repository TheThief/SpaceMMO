...
$result = $mysqli->query('CREATE TABLE shiphulls(hullID INT NOT NULL AUTO_INCREMENT, hullname CHAR(20), hulldescription VARCHAR(256), metalcost INT NOT NULL DEFAULT 0, size INT NOT NULL DEFAULT 0, maxweapons INT NOT NULL DEFAULT 0, mindrydock INT NOT NULL DEFAULT 0, PRIMARY KEY (hullID)) ENGINE=INNODB');
if ($result)
{
