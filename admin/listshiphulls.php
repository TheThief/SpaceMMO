...
function adminListShipHullsBody()
{
	...
	echo '<tr><th>Hull ID</th><th>Name</th><th>Description</th><th>Cost</th><th>Size</th><th>Max Weapons</th><th>Min Drydock Lvl</th><th>Class</th><th>Actions</th></tr>', $eol;
	...
	echo '<td>',htmlDropdown('hullclass','shipclass'),'</td>', $eol;
